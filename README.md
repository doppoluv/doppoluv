<div align="left">
  <h3 style="margin-bottom: 8px;">Hi there</h3>
</div>

<div align="left" style="margin: 12px 0 16px 0;">
  <img src="assets/gif.gif" width="420" align="right" alt="Profile animation" />
  ...
  <div style="margin-top: 10px;">
    <p style="font-size: 14px; margin: 0 0 4px 0;">Languages in repositories</p>
  ...
  <div style="margin-top: 10px;">
    <p style="font-size: 14px; margin: 0 0 4px 0;">LeetCode statistics</p>
